...
chisq_test_z
#P = 0.36, anlamlilik degeri a = 0.05 den büyük oldugundan rastgele olusturdugumuz
...
chisq_test_z2
#P = 0.73, anlamlilik degeri a = 0.05 den büyük oldugundan rastgele olusturdugumuz
#verilerin dagilimi ile belirtilen dagilim arasinda fark olmadigini söyleyebiliriz.
...
runs_test_z_x
#P degeri 0.84 oldugu için verilerin random oldugu söylenebilir.
